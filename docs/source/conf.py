...
project = 'Neoantigen Digital Twin'
copyright = '2022, Anja Moesch, Filippo Grazioli'
author = 'Anja, Filippo'
...
###
base_filename = 'neoag_dt'
short_description=  'Documentation for Neoantigen Digital Twin'
...
texinfo_documents = [
    (master_doc,
     ...
     author,
     short_description,
     'Creating neoantigen-based cancer vaccines based on a digital twin analysis.',
     category),
]
